        ...
        <form id="formCliente" name="formCliente" class="form-horizontal">
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <input type="tel" class="form-control" id="txtIdentificacion" name="txtIdentificacion" required="">
            </div>  
            <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
              <label for="txtApellido">Negócio <span class="required">*</span></label>
              <input type="text" class="form-control valid validText" id="txtApellido" name="txtApellido" required="">
            </div>  
            <div class="form-group col-md-12">
              <label for="txtTelefono">Teléfono <span class="required">*</span></label>
              <input type="tel" class="form-control valid validNumber" id="txtTelefono" name="txtTelefono" required="" onkeypress="return controlTag(event)">
            </div> 
            <div class="form-group col-md-12">
