      ...
      <div class="login-box">
        ...
        <form class="login-form" id="formLogin" name="formLogin" action="">
          ...
          <div class="form-group">
            <div class="form-group">
              <label class="txtRuta">RUTA</label>
              <input id="txtRuta" name="txtRuta" class="form-control" type="text" placeholder="Ruta" autofocus>
            </div>
            <div class="form-group">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-warning btn-block"><i class="fas fa-sign-in-alt"></i> INICIAR SESIÓN</button>
          </div>
        </form>
